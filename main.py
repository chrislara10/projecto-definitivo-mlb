...
from src.data_loader import download_historical_games_incremental, update_historical_games_single_day
...
from src.odds_provider import update_historical_odds_single_day
...
def main():
    ...
    if os.path.exists(cache_path):
        print("[main] Modo actualización diaria: cache detectado.")
        games_df = update_historical_games_single_day(
            cache_path=cache_path,
            target_date=end_date
        )
    else:
        print("[main] Modo carga inicial: cache no encontrado.")
    ...
    odds_cache_path = "data/odds_history.csv"
    if os.path.exists(odds_cache_path):
        print("[main] Odds modo actualización diaria: cache detectado.")
        odds_history_df = update_historical_odds_single_day(
            odds_api_key=ODDS_API_KEY,
            cache_path=odds_cache_path,
            target_date=end_date,
        )
    else:
        print("[main] Odds modo carga inicial: cache no encontrado.")
